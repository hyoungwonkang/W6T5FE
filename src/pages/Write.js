...
import { Grid_, Image, Text } from '../components/ui';
import { Button_, Input } from '../components/core';
...
const Write = (props) => {
  ...
  return (
    <React.Fragment>
      ...
      <Grid_ padding='16px'>
        {is_edit ? (
          <Button_ _onClick={editPost} text='수정하기'></Button_>
        ) : (
          <Button_ _onClick={addPost} text='작성하기'></Button_>
        )}
      </Grid_>
    </React.Fragment>
  );
